    ...
    <main-info>
        <div class="row align-items-center">
            ...
            <div class="col-md-9 d-flex flex-column justify-content-between">
                <a href="https://chatgpt.com/c/673c75b7-1314-8003-9f69-28721b408858" target="_blank">
                    <h4 class="font-weight-bold mb-2" style="font-size: 1.25rem; color: #333;">{{ job.name }}</h4>
                </a>
